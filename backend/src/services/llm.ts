...
class LLMService {
  ...
  async constitutionalCheck(ev: ConstitutionalCheckInput): Promise<ConstitutionalCheckResult> {
      ...
      response_format: {
        ...
        json_schema: {
          ...
          schema: {
            ...
            properties: {
              verdict: { type: "string", enum: ["constitutional", "unconstitutional", "unclear"] },
